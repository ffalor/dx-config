...
export PATH=$HOME/bin:/usr/local/bin:$HOME/.local/bin:$(go env GOPATH)/bin:$PATH
...
alias starship-edit="code ~/.config/starship.toml"

# misc
alias c="clear"
alias copy_ip="curl ipinfo.io | jq -r '.ip' | pbcopy"
...
alias creds-unset="unset FALCON_CLIENT_ID FALCON_CLIENT_SECRET FALCON_CID FALCON_PROV_TOKEN FALCON_DOCKER_API_TOKEN"
